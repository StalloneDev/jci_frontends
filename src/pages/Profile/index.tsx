...
const Profile = () => {
  ...
  return (
    <div className="p-4 min-h-screen bg-gray-50/50 dark:bg-gray-900/50 py-8">
      <motion.div 
        initial="hidden"
        animate="show"
        variants={container}
      ...
      >
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <motion.div variants={item} className="flex justify-end pb-20">
              <Button 
                type="submit" 
      ...
      <motion.footer 
        variants={item}
        className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-10"
      >
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-400">
            KJS - 2025 JCI Plateforme. Tous droits réservés.
          </span>
